	...
	class WP_Maintenance_Mode {
		...
		public function default_settings() {
			return array(
				...
				'design' => array(
					'title' => __('Situs dalam perbaikan', $this->plugin_slug),
					'heading' => __('Situs dalam perbaikan', $this->plugin_slug),
					'heading_color' => '',
					'text' => __('<p>Untuk Informasi lebih Lanjut mohon hubungi:<br>Bagian Humas Universitas Gadjah Mada : <a href="tel:0274123456">(0274) 123456</a> atau <a href="mailto:humas@ugm.ac.id?Subject=Hello%20again">humas@ugm.ac.id</a></p>', $this->plugin_slug),
					'text_color' => '',
					'bg_type' => 'color',
					'bg_color' => '',
					'bg_custom' => '',
